    ...
    <footer className="relative bg-slate-900/50 pt-16 pb-8 px-4 border-t border-white/5 mt-20">
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-6 mb-8">
          <a href="https://github.com/sumon2003" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-white transition-colors"><FaGithub size={22} /></a>
          <a href="https://www.linkedin.com/in/md-sumon-hossain-khan-885961266/" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-blue-400 transition-colors"><FaLinkedin size={22} /></a>
          <a href="https://wa.me/8801646819343" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-green-500 transition-colors"><FaWhatsapp size={22} /></a>
        </div>
