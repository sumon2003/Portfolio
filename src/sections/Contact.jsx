...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_d6ctibk', 'template_ll929yb', form.current, '156rZgPkVpwd2BTU3')
      .then(() => {
        setIsSuccess(true);
        setIsSending(false);
        e.target.reset();
  ...
  const copyToClipboard = () => {
    navigator.clipboard.writeText('musafir_sumon@email.com');
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="glass p-8 rounded-[2.5rem] border-white/5 space-y-6">
            ...
            <div className="flex items-center gap-4 text-slate-300 group cursor-pointer" onClick={copyToClipboard}>
              ...
              <div>
                ...
                <p className="text-lg font-medium">sumonkhanbd2003@email.com <FaCopy className="inline ml-2 text-xs opacity-50" /></p>
              </div>
            </div>
